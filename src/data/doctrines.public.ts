...
export interface PublicDoctrine {
  title: string;
  subtitle: string;
  content: string[];
}

export const doctrines: PublicDoctrine[] = [
  {
    title: 'Executive Risk Doctrine',
    subtitle: 'Strategic Volatility Governance',
    content: [
  ...
  {
    title: 'LatAm Investment Doctrine',
    subtitle: 'Cultural Fluency and Jurisdictional Precision',
    content: [
...

  {
    ...
    subtitle: 'Digital Integration and Institutional Integrity',
    content: [
