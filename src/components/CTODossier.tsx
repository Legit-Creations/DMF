...
export default function CTODossier() {
  return (
    <main className="w-full overflow-hidden bg-obsidian text-bone">
      {/* =========================================================
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_220px] lg:items-end">
            <div>
              <div className="mb-7 flex items-center gap-4">
                ...
                <p className="text-[9px] font-medium uppercase tracking-[0.55em] text-gold">
                  CTO Mandate // Digital Sovereignty
                </p>
              </div>

              <h1 className="max-w-4xl font-display text-5xl leading-[0.88] tracking-[-0.04em] sm:text-7xl lg:text-[7rem]">
                Digital
                <br />
              <span className="italic text-gold">Integration</span>
            </h1>
  ...
  <div className="mt-14 grid gap-5 border-t border-white/10 pt-8 sm:grid-cols-3">
    <div className="flex items-center gap-3">
      <Fingerprint className="h-4 w-4 text-gold/70" />
    ...
    <div className="flex items-center gap-3">
      <Network className="h-4 w-4 text-gold/70" />
    ...
    <div className="grid gap-10 lg:grid-cols-[180px_minmax(0,1fr)]">
      ...
      <div>
        ...
        <p className="mt-4 max-w-2xl text-sm leading-7 text-neutral-500">
          Three technical domains form the core of the CTO mandate:
            ...
            <div className="grid gap-10 lg:grid-cols-[180px_minmax(0,1fr)_220px]">
              ...
              <div>
                <div className="mb-6 flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center border border-gold/30 text-gold transition-colors duration-500 group-hover:border-gold group-hover:bg-gold group-hover:text-obsidian">
        ...
        <div className="mt-12 grid border-y border-white/10 sm:grid-cols-3">
          {governancePrinciples.map((principle, index) => (
            <MotionDiv
              ...
              className="border-b border-white/10 py-10 sm:border-b-0 sm:border-r sm:px-8 sm:first:pl-0 sm:last:border-r-0 sm:last:pr-0"
              >
