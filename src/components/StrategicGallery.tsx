...
const images: GalleryImage[] = [{
  id: 1,
  src: "https://hv4w1qmfjrk8zaij.public.blob.vercel-storage.com/684082b08064a259b26c8ac3_final.jpg",
  title: "GFA Headquarters",
  span: "lg:col-span-1 lg:row-span-1",
  coord: "14.07°N / 87.19°W",
  status: "Operational"
},
  {
    id: 2,
    src: "https://hv4w1qmfjrk8zaij.public.blob.vercel-storage.com/Fachada-1-Banco-Atlantida.webp",
    title: "Strategic Infrastructure",
    span: "lg:col-span-1 lg:row-span-2",
    coord: "Asset ID: 992-B",
    status: "Secure"
  },
  {
    id: 3,
    src: "https://hv4w1qmfjrk8zaij.public.blob.vercel-storage.com/683c906b73a0abb8064ee03f__DAS1362.jpg",
    title: "Digital Integration",
    span: "lg:col-span-1 lg:row-span-1",
    coord: "Node: Tegucigalpa",
    status: "Encrypted"
  },
  {
    id: 4,
    src: "https://hv4w1qmfjrk8zaij.public.blob.vercel-storage.com/ebn-Atlantida.jpg",
  ...
  },
  {
    ...
    title: "Primary Asset Growth",
    span: "lg:col-span-2 lg:row-span-2",
    coord: "04.11°N / 09.21°E",
    status: "Strategic"
  },
  {
    id: 6,
    src: "https://hv4w1qmfjrk8zaij.public.blob.vercel-storage.com/images%20%283%29.jpeg",
    title: "Wealth Acceleration",
    span: "lg:col-span-1 lg:row-span-1",
    coord: "Tier: Institutional",
    status: "Verified"
  },
  {
    id: 7,
    src: "https://hv4w1qmfjrk8zaij.public.blob.vercel-storage.com/portada-09-02-2024-111-juntos.jpg",
    title: "Global Reach",
    span: "lg:col-span-1 lg:row-span-1",
    coord: "Network Bridge",
    status: "Optimized"
  },
  {
    id: 8,
    src: "https://hv4w1qmfjrk8zaij.public.blob.vercel-storage.com/images.jpeg",
    title: "Sustainability",
    span: "lg:col-span-1 lg:row-span-1",
    coord: "ESG Protocol 1.1",
    status: "Compliant"
  },
];
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-12">
              ...
              <span className="text-gold font-bold tracking-[0.5em] text-[10px] uppercase">Contra Atlantis Group assets.</span>
            </div>
            <h2 className="text-3xl md:text-6xl font-serif italic text-obsidian tracking-tighter leading-[1.1]">
              Company <br /> <span className="not-italic text-gold font-bold uppercase">Environments</span>
          </h2>
