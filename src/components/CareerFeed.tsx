...
const ledgerData = [
  ...
  },
  {
    ...
    title: "AFP CONFIA's image is evolving to reaffirm its strength and track record.",
    desc: "CONFIA's visual evolution is a manifestation of its continuous pursuit of excellence, reflecting its adaptability and forward-thinking vision. This rebranding modernizes its market presence and reinforces its membership in Grupo Financiero Atlántida.",
  ...
  return (
    <section id="ledger" className="py-24 md:py-40 bg-[#F6F6F3] text-obsidian px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        {/* HEADER: Institutional Typography - Fixed alignment */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 md:gap-12 mb-24 border-b border-obsidian/10 pb-12">
          <div className="space-y-4 w-full md:w-auto">
            <div className="flex mb-6 items-center gap-3">
              <Newspaper className="text-gold w-4 h-4 shrink-0" />
          ...
          <div className="max-w-md w-full space-y-4">
            <p className="text-xs uppercase tracking-[0.2em] font-bold text-obsidian/40 text-left">
              Executive Log // public archives and Information reach
            </p>
            <p className="text-base md:text-lg text-left font-light leading-relaxed text-ash">
              A centralized repository for CONTRA ATLANTIS GROUP. A notification space for showcasing our leadership updates, management insights, and real-time synchronization of the company daily operation refreshed public notice.
            </p>
          </div>
        </div>
          ...
          {ledgerData.map((item, index) => (
            ...
            >
              ...
              <div className="p-8 space-y-6">
                ...
                <p className="text-sm text-left font-light leading-relaxed text-ash line-clamp-3">
                  {item.desc}
                </p>
        ...
        <div className="mt-24 pt-12 border-t border-obsidian/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs font-mono">on-the-go</span>
            </div>
          </div>
        </div>
      </div>
