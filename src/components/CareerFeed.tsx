        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-12 mb-24 border-b border-obsidian/10 pb-12">
          <div className="space-y-4">
            ...
            <motion.h2 initial={ { opacity: 0, y: 30 }}
              ...
              transition={ { duration: 0.8 }} className="text-3xl md:text-6xl font-serif italic text-obsidian tracking-tighter leading-[1.1]">Executive <br />
            <span className="not-italic text-gold font-bold uppercase">Ledger</span>
          </motion.h2>
        </div>
        <div className="max-w-xs space-y-4">
          <p className="text-xs uppercase tracking-[0.2em] font-bold text-obsidian/40 content-justify">
